    ...
    <SlideSection id="title">
      <BentoGrid>
        ...
        <BentoCell className="col-span-12 relative overflow-hidden py-20 md:py-32 min-h-[60vh] justify-center">
           ...
           <div className="absolute inset-0 bg-gradient-to-br from-accent-subtle via-surface-canvas/95 to-surface-canvas" />
           
           {/* Content */}
           <div className="relative z-10 flex flex-col justify-center items-center text-center max-w-4xl mx-auto">
             <h1 className="font-serif-jp text-5xl md:text-7xl font-medium text-ink-primary mb-8 tracking-widest bg-surface-card px-8 py-4 border-2 border-accent-main shadow-lg">
               MIZUSHIRO
             </h1>
        ...
        <BentoCell className="col-span-6 md:col-span-3 hover:bg-accent-subtle transition-colors group">
           ...
           <div className="font-mono mt-2 text-3xl font-medium text-accent-main group-hover:text-accent-hover transition-colors">300+</div>
        </BentoCell>
        <BentoCell className="col-span-6 md:col-span-3 hover:bg-accent-subtle transition-colors group">
           <Label>CHAINS CONNECTED</Label>
           <div className="font-mono mt-2 text-3xl font-medium text-accent-main group-hover:text-accent-hover transition-colors">10+</div>
        </BentoCell>
        <BentoCell className="col-span-6 md:col-span-3 hover:bg-accent-subtle transition-colors group">
           <Label>TVL COMMITTED</Label>
           <div className="font-mono mt-2 text-3xl font-medium text-accent-main group-hover:text-accent-hover transition-colors">$10M+</div>
        </BentoCell>
        <BentoCell className="col-span-6 md:col-span-3 flex flex-col justify-end items-end hover:bg-accent-subtle transition-colors">
           ...
           <div className="font-mono mt-2 flex items-center gap-2 text-sm font-medium text-ink-primary">
             <span className="w-2 h-2 bg-accent-main animate-pulse rounded-full"></span> PRE-LAUNCH
           </div>
        </BentoCell>
      </BentoGrid>
    </SlideSection>
