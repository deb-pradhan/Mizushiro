      ...
      <BentoGrid>
          ...
          <div className="h-full flex flex-col justify-center">
            ...
            <div className="space-y-6">
              <div className="flex gap-4 items-start group">
                <span className="w-10 h-10 bg-accent-main text-ink-on-accent flex items-center justify-center text-sm font-medium shrink-0 shadow-[0_0_15px_rgba(155,28,28,0.4)] group-hover:shadow-[0_0_25px_rgba(155,28,28,0.6)] transition-shadow">1</span>
              ...
              <div className="flex gap-4 items-start group">
                <span className="w-10 h-10 bg-accent-main text-ink-on-accent flex items-center justify-center text-sm font-medium shrink-0 shadow-[0_0_15px_rgba(155,28,28,0.4)] group-hover:shadow-[0_0_25px_rgba(155,28,28,0.6)] transition-shadow">2</span>
              ...
              <div className="flex gap-4 items-start group">
                <span className="w-10 h-10 bg-accent-main text-ink-on-accent flex items-center justify-center text-sm font-medium shrink-0 shadow-[0_0_15px_rgba(155,28,28,0.4)] group-hover:shadow-[0_0_25px_rgba(155,28,28,0.6)] transition-shadow">3</span>
        ...
        <BentoCell className="col-span-12 md:col-span-6 bg-surface-card">
          ...
          <div className="space-y-5">
            ...
            <div className="border-l-4 border-accent-main/60 pl-6 py-2 hover:bg-accent-subtle/30 transition-colors">
            ...
            <div className="border-l-4 border-accent-main/40 pl-6 py-2 hover:bg-accent-subtle/30 transition-colors">
        ...
        <BentoCell className="col-span-12 bg-accent-subtle/30 border-t-4 border-accent-main">
          <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-6">
            ...
            <div className="flex items-center gap-6 text-sm bg-surface-card px-6 py-4 border-2 border-accent-main shadow-[0_0_20px_rgba(155,28,28,0.3)]">
