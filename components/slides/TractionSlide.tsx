...
export const TractionSlide = () => {
  return (
     <SlideSection id="traction">
       ...
       <BentoGrid>
          {/* Main Stats */}
          <BentoCell className="col-span-12 md:col-span-4 !bg-accent-main shadow-xl">
             <div className="flex flex-col h-full justify-between text-ink-on-accent">
                <div>
                  ...
                  <div className="text-5xl md:text-7xl font-medium tracking-tighter leading-none mb-4">$10M+</div>
          ...
          <BentoCell className="col-span-12 md:col-span-8 bg-surface-card">
             ...
             <div className="grid grid-cols-2 md:grid-cols-3 gap-4 mt-8">
               <div className="border-2 border-accent-main p-6 flex flex-col justify-between h-32 bg-accent-subtle hover:bg-accent-subtle/80 transition-colors group">
               ...
               <div className="border border-border-grid p-6 flex flex-col justify-between h-32 hover:border-accent-main hover:bg-accent-subtle transition-all group">
            ...
            <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-8">
              ...
              <div className="flex items-end gap-12 pr-8">
                ...
                <div className="text-center">
                  <div className="w-16 bg-accent-main h-24 mb-2 mx-auto shadow-lg"></div>
