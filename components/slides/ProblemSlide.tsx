      ...
      <BentoGrid>
        ...
        <BentoCell className="col-span-12 md:col-span-4">
           ...
           <div className="flex flex-col gap-4 mt-6">
             <div className="border-2 border-accent-main p-4 flex items-center justify-between bg-accent-subtle/30">
        ...
        <BentoCell className="col-span-12 md:col-span-8 bg-surface-subtle relative overflow-hidden">
             <div className="absolute inset-0 opacity-20 pointer-events-none" 
                  style={{ backgroundImage: 'radial-gradient(circle, #9B1C1C 1px, transparent 1px)', backgroundSize: '8px 8px' }}>
             </div>
             ...
             <div className="mt-6 relative z-10">
               ...
               <div className="grid grid-cols-2 md:grid-cols-4 gap-3 mb-8">
                  {['PYTH', 'ASTER', 'HYPE', 'HBAR', 'ENA', 'RENDER', 'STRK', 'ONDO'].map((token) => (
                    <div key={token} className="border border-border-element bg-surface-card p-4 text-center hover:border-accent-main hover:bg-accent-subtle/30 transition-all cursor-default group">
             ...
             <div className="border-t border-border-grid pt-6 relative z-10">
               ...
               <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
                  <div className="flex items-center gap-3 text-ink-secondary font-medium">
                    <span className="w-6 h-6 bg-accent-main/20 border border-accent-main flex items-center justify-center text-accent-main text-sm">✕</span> No Yield
                  </div>
                  <div className="flex items-center gap-3 text-ink-secondary font-medium">
                    <span className="w-6 h-6 bg-accent-main/20 border border-accent-main flex items-center justify-center text-accent-main text-sm">✕</span> No Hedging
                  </div>
                  <div className="flex items-center gap-3 text-ink-secondary font-medium">
                    <span className="w-6 h-6 bg-accent-main/20 border border-accent-main flex items-center justify-center text-accent-main text-sm">✕</span> No Shorting
                  </div>
               </div>
             </div>
        </BentoCell>
